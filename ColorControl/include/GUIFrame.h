...
class PanelHeader : public wxPanel
{
	...
	public:
		...
		PanelHeader( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 932,35 ), long style = wxTAB_TRAVERSAL, bool useNetX = true );
		~PanelHeader();
		void UpdateHeader( bool useNetX );
...
public:
    FrameChromaticity (wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, bool useNetX = true)
